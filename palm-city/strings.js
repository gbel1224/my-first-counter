...
export const STR = {
  ...
  controlsHint: "Keyboard: WASD/arrows to move, E = car, Space = brake, B = buy/horn, Enter = talk.  Gamepad supported.",
  legend: ["🕹️ Left side — move & steer", "↑ Push up — accelerate", "Ⓐ Enter / exit car", "🛑 Brake / reverse"],
  start: "START",
  ...
  ach: {
    car1:    { name: "First Wheels",    desc: "Buy a car at the City Garage" },
    car3:    { name: "Car Collector",   desc: "Own all 3 personal cars" },
    biz6:    { name: "Property Mogul",  desc: "Own all 6 businesses" },
  ...
  mods: { engine: "Engine", turbo: "Turbo", grip: "Tyres" },
  modLabel: (name, lvl, cost) => name + " Lv" + lvl + " → $" + cost.toLocaleString("en-US"),
  modMax: name => name + " ✓MAX",
  modBought: (name, lvl) => name + " upgraded to Lv" + lvl + "!",

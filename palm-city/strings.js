...
export const STR = {
  ...
  tutLines: [
    ...
    "Ⓐ button (or E) to get in / out of cars",
    "🛑 brake · ⚡ BOOST nitro · 👊 PUNCH on foot",
    "🏪 Walk up to glowing buildings to buy or use them",
    "🎯 Follow the yellow marker for your next goal",
    "⛽ Watch fuel & ❤️ health — refuel at the gas station",
    "💾 Your city saves automatically",
  ],
  tutBtn: "LET'S GO",
  start: "START",
  ...
  reward: r => "+$" + r,
  levelUp: (l, b) => "⭐ LEVEL " + l + "!  Reward +$" + b.toLocaleString("en-US"),
  lvlBadge: l => "LV " + l,
  ...
  crookSpotted: "🚨 Crook on the loose — run them down!",
  crookBusted: r => "Crook busted! +$" + r,
  crookEscaped: "The crook slipped away…",
  hospitalName: "🏥 HOSPITAL",
  gasName: "⛽ FUEL",
  lowFuel: "⛽ Low fuel — find a gas station",
  medicCall: "🚑 Emergency — pick up the patient!",
  medicAboard: "Patient aboard — rush to the hospital!",
  medicDelivered: r => "Patient saved! +$" + r,
  medicLost: "The patient couldn't wait…",
  ...
  ach: {
    ...
    vigil:    { name: "Street Justice", desc: "Bust 5 crooks on the run" },
    homeowner: { name: "Homeowner",     desc: "Buy your own apartment" },
    medic:    { name: "First Responder", desc: "Save 5 patients" },
    tycoon:  { name: "Palm City Tycoon", desc: "Bank $50,000" },
    story:   { name: "King of the City", desc: "Finish the 12-chapter story" },
    lvl10:   { name: "Rising Star",     desc: "Reach player level 10" },
    lvl25:   { name: "City Legend",     desc: "Reach player level 25" },
  },
  ...
  wasted: f => "WASTED! Patched up — fine $" + f.toLocaleString("en-US"),
  btnPunch: "PUNCH",
  jump: b => "SWEET JUMP! +$" + b,
  ...
  homeForSale: "🏠 FOR SALE — $6,000",
  homeOwned: "🏠 HOME",
  btnBuyHome: cost => "BUY HOME · $" + cost.toLocaleString("en-US"),
  btnRest: "🛏 REST",
  homeBought: "Welcome home! 🏠",
  rested: "You rest up — time passes…",
  propForSale: (name, cost) => name + " — FOR SALE · $" + cost.toLocaleString("en-US"),
  propOwned: name => name + " — OWNED ✅",
  btnBuyProp: (name, cost) => "BUY " + name + " · $" + cost.toLocaleString("en-US"),
  propBought: name => "You bought the " + name + "! 🔑",
